...
<template>
  <section>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
      <div v-if="profile.email" class="flex items-center space-x-3">
        <svg
      ...
      <div v-if="profile.phone" class="flex items-center space-x-3">
        <svg
          class="w-5 h-5 text-blue-500"
          fill="none"
          stroke="currentColor"
      ...
      <div v-if="profile.linkedin" class="flex items-center space-x-3">
        <svg
          class="w-5 h-5 text-blue-500"
          fill="currentColor"
          viewBox="0 0 24 24"
        ...
        <a
          :href="formatLink(profile.linkedin)"
          target="_blank"
          class="text-gray-700 hover:text-blue-600"
        >
      ...
      <div v-if="profile.github" class="flex items-center space-x-3">
        <svg
          class="w-5 h-5 text-blue-500"
          fill="currentColor"
          viewBox="0 0 24 24"
        ...
        <a
          :href="formatLink(profile.github)"
          target="_blank"
          class="text-gray-700 hover:text-blue-600"
        >
      ...
      <div
        ...
        class="flex items-center space-x-3 md:col-span-2"
      >
        <svg
          class="w-5 h-5 text-blue-500"
          fill="none"
